...
public interface IService {
     ...
     * @return 数据实体
     */
    <S extends AbstractEntity> S insert(S entityInsert);
     ...
     * @return 数据实体集合
     */
    <S extends AbstractEntity> Iterable<S> insert(Iterable<S> entitiesInsert);
     ...
     * @return 更新的条数
     */
    <S extends AbstractEntity> int update(S entityUpdate);
     ...
     * @return 更新的条数
     */
    <S extends AbstractEntity> int update(String statementKey, S entityUpdate);
